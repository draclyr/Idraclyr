          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                <div className="mx-auto text-center mb-9">
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        <stop stopColor="#B8001F" stopOpacity="0" />
                        <stop offset="1" stopColor="#B8001F" />
                      </linearGradient>
                      <linearGradient
                ...
                <Link
                  href="/"
                  className="px-8 py-3 text-base font-bold text-white duration-300 rounded-md bg-red-500 shadow-signUp hover:bg-white hover:text-red-800 md:px-9 lg:px-8 xl:px-9"
                >
                  Back to Homepage
                </Link>
              </div>
